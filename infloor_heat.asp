    ...
    <!--#include file="includes/navigation.asp"-->
		...
		<main role="main">
			<section>
				...
				<!-- figure 1. -->
				<figure>
					<img src="images/construction_site.jpg" alt="Figure 1."><!-- How to best support accessibility here? -->
					<figcaption>
						Figure 1. Hydronic radiant floor heating tubing laid out in specific heating pattern prior to concrete pour. Photo courtesy of Ready Mixed Concrete Association of Ontario.
					</figcaption>
				</figure>
				<p>
				...
				<figure>
					<img src="images/floor_cross_section.jpg" alt="Figure 2."><!-- alt tags need more description -->
					<figcaption>
				...
				<aside>
					...
					<figure>
						<img src="images/home_cross_section.jpg" alt="Figure 3.">
						<figcaption>
				...
				<section>
					...
					<p>
						A circulator pump near the water supply manifold moves the water from the mixing valve to the supply manifold into the distribution piping system (tubing) inside the floors. Properly designed, this delivers even heat to rooms. A properly designed radiant floor system will not exceed 29&deg;C (85&deg;F).
					</p>
					<p>
