		...
		<main>
			<section>
				...
				<section>
					...
					<p>
						There are three components to this heating system: a heat source, a distribution piping system and controls (figure 4). The heat source in hydronic radiant floor heating is usually a boiler or a hot water heater, but other heat sources can be used too. The energy used to heat the hot water can be natural gas, oil, electricity, propane, wood or solar hot water collection.
					</p>
					<p>
