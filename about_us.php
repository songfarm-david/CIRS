    ...
    <main role="main">
                ...
                <figcaption>
      		    ...
      		    <h4>
    			    ...
    			    <ul>
    				    ...
    				    <li>
    					    covered with lightweight gypsum cement over plywood or existing floors
    				    </li>
    				    <li>
      		    ...
      		    <h4>
    			    ...
    			    <ul>
    				    ...
    				    <li>
    					    Radiant heating costs far less to run than forced air.
    				    </li>
    				    <li>
    					    Radiant homes are draft, dust, and allergen free.
    				    </li>
    				    <li>
    					    Our overpours are self leveling, solving uneven floor issues.
    				    </li>
    				    <li>
      ...
      <aside role="complementary" id="partners" class="full-width">
        ...
        <div>
          ...
          <a href="http://www.oakvillechamber.com/" rel="external" target="_blank"><img src="images/partners/logo-oakvillechamber.gif" alt="Oakville Chamber of Commerce website" title="Oakville Chamber of Commerce"></a>
